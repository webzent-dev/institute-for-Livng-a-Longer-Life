...
class AdminCourseController extends Controller
{
    public function index()
    {
        ...
        //Member Courses
        $memberCourses = Course::selectRaw('courses.id as course_id, courses.*')
        ->join('users', 'courses.user_id', '=', 'users.id')
        ->where('users.role', 'user')
        ->paginate(10);

        //Collaborator Courses
        $collaboratorCourses = Course::selectRaw('courses.id as course_id, courses.*')
        ->join('users', 'courses.user_id', '=', 'users.id')
        ->where('users.role', 'collaborator')
        ->paginate(10);


        return view('admin.courses.index', compact('courses', 'instructors', 'courseCategories', 'memberCourses', 'collaboratorCourses'));
    }

    public function coursesDetails()
    {
        return view('admin.courses.course-detail');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.courses')->with('success', 'Course has been added successfully.');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.courses.show', compact('courseDetail', 'courseImages', 'instructors', 'courseCategories'));
    }
    ...
    public function destroy(int $id=0)
    {
        ...
        $course->delete();
        return redirect()->route('admin.courses')->with('success', 'Course has been deleted successfully.');
    }

...
class AdminHelpCategoryController extends Controller
{
    ...
    {
        $helpCategories = HelpCategory::paginate(10);
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->back()->with('error', 'Unable to delete help category because it is associated with other records. Please try again...!!!');
        }
    }

...
class AdminProductController extends Controller
{
    ...
    {
        //Institute products
        $instituteProducts = Product::with('user')->selectRaw('products.id as product_id, products.*')->join('users', 'products.user_id', '=', 'users.id')->where('users.role', 'admin')->whereIn('products.category',['institute', 'vital_boost'])->get();

        //Collaborator products wtih select and alias fields 
        $collaboratorProducts = Product::with('user')->selectRaw('products.id as product_id, products.*')->join('users', 'products.user_id', '=', 'users.id')->where('users.role', 'collaborator')->where('products.category','collaborator')->get();

        //Member products
        $memberProducts = Product::with('user')->selectRaw('products.id as product_id, products.*')->where('products.category', 'member_exclusive')->get();

            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-gray-600 bg-gray-50 p-3 rounded">
                                {{ ucfirst(session('checkout.delivery.method')) }} Delivery - ${{ session('checkout.delivery.charge') }}<br>
                                <span class="text-xs">Estimated delivery: 5-7 business days</span>
                                @if(session('checkout.delivery.instructions'))
                                <br><strong>Instructions:</strong> {{ session('checkout.delivery.instructions') }}
                                @endif
                            </div>
                        </div>
                        <!-- Payment Method -->
                ...
                <form action="{{ route('checkout.place-order') }}" method="POST" id="place-order-form">
                    ...
                    <div class="flex justify-between">
                        ...
                        <button type="submit" id="place-order-btn" class="inline-flex items-center px-6 py-3 bg-gray-400 text-white font-semibold rounded-md cursor-not-allowed opacity-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" disabled>
                        Place Order
                ...
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6 sticky top-6">
                    ...
                    <div class="border-t border-gray-200 pt-4 space-y-2">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">${{ session('checkout.delivery.charge') ?? '0.00' }}</span>
                            <input type="hidden" id="shipping_cost" value="{{ session('checkout.delivery.charge') ?? '0.00' }}">
                        </div>
                        <div class="flex justify-between">

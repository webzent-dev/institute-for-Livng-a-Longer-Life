...
<main class="flex-1 font-jakarta">
    ...
    <section class="py-12 bg-[#f8faf8]">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 w-full mx-auto my-8">
                <!-- Card -->
                @foreach ($arr as $item)
                ...
                @foreach($memberships as $plan)
                    ...
                    <div class="relative"   x-data="{ selectedPlan: { name: '', price: '', period: '' } }">
                        ...
                        <div class=" border-gray-200 flex-1 flex flex-col px-6 pb-6">
                            ...
                            <button type="button" class="{{ $isPopular ? 'gradient-primary text-primary-foreground hover:opacity-90 shadow-medium font-semibold' : 'border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground' }} h-11 rounded-md px-8 w-full mt-8" command="show-modal"  commandfor="dialog" data-plan-name="{{ $plan['name'] }}" data-plan-price="{{ $plan['price'] }}" data-plan-period="{{ $plan['period'] }}" onclick="openPlanModal(this)">Get Started</button>
            ...
            <div class="max-w-4xl mx-auto text-center">
                ...
                <form action="{{ route('newsletter.subscribe') }}" method="POST" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <x-form.input name="firstName" placeholder="Enter First Name*" autocomplete="off" required />
                        </div>
                        <div>
                            <x-form.input name="lastName" placeholder="Enter Last Name*" autocomplete="off" required />
                        </div>
                    </div>
                    <div>
                        <x-form.input name="email" placeholder="Enter Email*" autocomplete="off" required />
                    </div>
                    <div>
                        <x-form.select
                            name="gender"

    ...
    <section class="gradient-subtle pb-5">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="flex justify-between items-center mb-6">
                {{-- <p id="resultsCount" class="text-lg font-medium text-gray-700"></p>
                for result --}}
                        ...
                        <div class="bg-white rounded-md shadow-sm p-4 md:p-5 lg:p-6 lg:sticky lg:top-4">
                            <div class="grid  lg:grid-cols-5 gap-4 items-center">
                                ...
                                <div class="">
                                    ...
                                    <div class="space-y-4">
                                        <div class="flex items-center justify-between">
                                            <input type="number" id="minPrice" placeholder="Min $" min="0" class="w-28 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none">
                                            <span class="text-gray-500 space-x-2">to</span>
                                            <input type="number" id="maxPrice" placeholder="Max $" min="0" class="w-28 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none">
                                    </div>
                                    </div>
                                </div>
                                ...
                                {{--<div class="mb-8">
                                    ...
                                    <div class="relative">
                                        <select id="vendorFilter" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none appearance-none bg-white">
        ...
        productsGrid.innerHTML = list.map(product => {
            ...
            <div class="aspect-square bg-gradient-to-br from-primary/10 to-accent/10 flex items-center justify-center rounded-t-lg relative">
                ...
                <div class="p-5">
                    ...
                    <p class="text-sm text-primary mb-1">by ${vendorName}</p>
                ...
                <div class="py-4 pt-0 justify-self-center w-full px-4">
                    <x-button-use label="Add to Cart" variant="primary" icon="shopping-cart" iconPosition="left" class="w-full" @click="addToCart(${product.id})"/>
                </div>
            </div>`;
        }).join('');

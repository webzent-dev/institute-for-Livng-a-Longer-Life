            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="space-y-6">
                        ...
                        <h1 class="text-4xl lg:text-6xl font-bold text-foreground text-left">{{ $product->name }}</h1>
                        <p class="text-2xl text-muted-foreground">Your Daily Foundation for Longevity and Vitality</p>
        ...
        <section class="container-base py-20 bg-background">
            ...
            <div class="container-base max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h2 class="text-3xl lg:text-5xl font-bold text-foreground mb-4">Comprehensive Health Benefits</h2>
                    ...
                    <div class="shadow-strong rounded-xl bg-white">
                        <div class="text-center pb-8 p-8">
                            ...
                            <p class="text-xl text-muted-foreground">
                                Each ingredient selected for proven efficacy and optimal bioavailability
                            </p>
                        </div>
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <div class="rounded-lg border bg-card text-card-foreground shadow-sm shadow-strong">
                    <div class="p-8 lg:p-12">
                        ...
                        <x-button-use href="{{ url('/shop') }}" label="Order Vital Boost Now" variant="primary"  icon="zap" class="w-1/3 justify-self-center" />

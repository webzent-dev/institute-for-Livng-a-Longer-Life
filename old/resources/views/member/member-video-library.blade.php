                    ...
                    <section>
                        ...
                        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div class="rounded-lg border bg-card text-card-foreground shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                                <div class="p-4">
                                    <div class="aspect-video bg-muted rounded-lg flex items-center justify-center mb-3">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="rounded-lg border bg-card text-card-foreground shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                        ...
                        <div class="p-6 pt-0 text-center">
                            ...
                            <button class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors border-2 border-primary bg-background text-primary hover:bg-primary hover:text-primary-foreground h-9 rounded-md px-3 mt-3">View Videos</button>
                        </div>
                    </div>
                    @endforeach
                </div>

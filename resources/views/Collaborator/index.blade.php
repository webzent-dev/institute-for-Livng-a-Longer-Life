...
@endif
        ...
        <form method="POST" action="{{ route('collaborator.login') }}" class="mt-8 space-y-6 bg-white py-6 sm:py-8 px-4 sm:px-6 shadow-lg rounded-xl border border-gray-200">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        autocomplete="email"
                        value="{{ old('email') }}"
                        class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition duration-200 @error('email') border-red-500 @enderror"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition duration-200 @error('password') border-red-500 @enderror"
            ...
            {{-- <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                ...
                <div class="text-sm">
                    <a href="#" class="font-medium text-primary hover:text-primary transition duration-150">Forgot your password?</a>
                    <a href="{{ route('admin.password.request') }}" class="font-medium text-blue-600 hover:text-blue-500 transition duration-150">Forgot your password?</a>
                </div>
            </div> --}}

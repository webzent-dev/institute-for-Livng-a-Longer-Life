...
<head>
    ...
    <title>@yield('title', 'Admin Business Details | Institute for Living Longer - Your Journey to Wellness')</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="space-y-8 max-w-4xl ">
                <!-- Header -->
                <div>
                    <h1 class="text-3xl font-bold text-foreground mb-2 text-left">Admin Business Details</h1>
                    <p class="text-muted-foreground">Update your business information for payments and verification</p>
                </div>
                <form action="{{ route('admin.business-details.store') }}" method="POST" class="space-y-8">
                    @csrf
                    ...
                    <div class="flex justify-end space-x-4">
                        <a href="{{ route('admin.dashboard') }}" class="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2">
                            Cancel
                        </a>

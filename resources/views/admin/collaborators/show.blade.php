            ...
            <div class="flex-1 flex flex-col">
                ...
                <div class="space-y-6">
                    ...
                    <div dir="ltr" data-orientation="horizontal">
                        <div role="tablist" aria-orientation="horizontal" class="flex h-10 w-full items-center rounded-md bg-muted p-1 text-muted-foreground space-x-1 overflow-x-auto" tabindex="0">
                            ...
                            <button role="tab" aria-selected="false" data-state="inactive" data-tab="business_details" aria-controls="business_details" type="button" class="inline-flex items-center justify-center rounded-sm px-3 py-1.5 text-sm font-medium transition-all">
                                Business Details
                            </button>
                            <button role="tab" aria-selected="false" data-state="inactive" data-tab="bank_details" aria-controls="bank_details" type="button" class="inline-flex items-center justify-center rounded-sm px-3 py-1.5 text-sm font-medium transition-all">
                                Bank Details
                            </button>
                            ...
                            <div class="p-6 pt-0">
                                @if($businessDetails)
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <div class="space-y-3">
                                                <div>
                                                    ...
                                                    <p class="text-base">{{ $businessDetails->business_name ?? 'N/A' }}</p>
                                                </div>
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">Business Type</label>
                                                    <p class="text-base">{{ ucfirst($businessDetails->business_type ?? 'N/A') }}</p>
                                                </div>
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">Business Phone</label>
                                                    <p class="text-base">{{ $businessDetails->business_phone ?? 'N/A' }}</p>
                                                </div>
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">Business Email</label>
                                                    <p class="text-base">{{ $businessDetails->business_email ?? 'N/A' }}</p>
                                                </div>
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">Business Website</label>
                                                    <p class="text-base">
                                                        @if($businessDetails->business_website)
                                                            <a href="{{ $businessDetails->business_website }}" target="_blank" class="text-primary hover:underline">{{ $businessDetails->business_website }}</a>
                                                        @else
                                                            N/A
                                                        @endif
                                                    </p>
                                        ...
                                        <div>
                                            <h4 class="font-semibold text-lg mb-4">Address Information</h4>
                                            <div class="space-y-3">
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">Address</label>
                                                    <p class="text-base">{{ $businessDetails->business_address ?? 'N/A' }}</p>
                                                </div>
                                                <div class="grid grid-cols-3 gap-3">
                                                    <div>
                                                        <label class="text-sm font-medium text-muted-foreground">City</label>
                                                        <p class="text-base">{{ $businessDetails->business_city ?? 'N/A' }}</p>
                                                    </div>
                                                    <div>
                                                        <label class="text-sm font-medium text-muted-foreground">State</label>
                                                        <p class="text-base">{{ $businessDetails->business_state ?? 'N/A' }}</p>
                                                    </div>
                                                    <div>
                                                        <label class="text-sm font-medium text-muted-foreground">ZIP Code</label>
                                                        <p class="text-base">{{ $businessDetails->business_zip_code ?? 'N/A' }}</p>
                                                    </div>
                                                </div>
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">Country</label>
                                                    <p class="text-base">{{ $businessDetails->business_country ?? 'N/A' }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-6">
                                        <h4 class="font-semibold text-lg mb-4">Tax Information</h4>
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                <label class="text-sm font-medium text-muted-foreground">Tax ID</label>
                                                <p class="text-base">{{ $businessDetails->tax_id ?? 'N/A' }}</p>
                                            </div>
                                            <div>
                                                <label class="text-sm font-medium text-muted-foreground">EIN Number</label>
                                                <p class="text-base">{{ $businessDetails->ein_number ?? 'N/A' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    @if($businessDetails->business_description)
                                        <div class="mt-6">
                                            <h4 class="font-semibold text-lg mb-4">Business Description</h4>
                                            <p class="text-base">{{ $businessDetails->business_description }}</p>
                                        </div>
                                    @endif
                                @else
                    ...
                    <div id="bank_details" class="tab-content mt-2 hidden">
                        <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
                            <div class="flex flex-col space-y-1.5 p-6">
                                <h3 class="text-2xl font-semibold leading-none tracking-tight">Bank Details</h3>
                                <p class="text-sm text-muted-foreground">Collaborator's US banking information</p>
                            </div>
                            <div class="p-6 pt-0">
                                @if($bankDetails)
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            <h4 class="font-semibold text-lg mb-4">Account Information</h4>
                                            <div class="space-y-3">
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">Account Holder Name</label>
                                                    <p class="text-base">{{ $bankDetails->account_holder_name ?? 'N/A' }}</p>
                                                </div>
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">Bank Name</label>
                                                    <p class="text-base">{{ $bankDetails->bank_name ?? 'N/A' }}</p>
                                                </div>
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">Account Type</label>
                                                    <p class="text-base">{{ ucfirst($bankDetails->account_type ?? 'N/A') }}</p>
                                                </div>
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">Routing Number</label>
                                                    <p class="text-base">{{ $bankDetails->routing_number ?? 'N/A' }}</p>
                                                </div>
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">Account Number</label>
                                                    <p class="text-base">****{{ substr($bankDetails->account_number ?? '', -4) }}</p>
                                                </div>
                                                @if($bankDetails->swift_code)
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">SWIFT Code</label>
                                                    <p class="text-base">{{ $bankDetails->swift_code }}</p>
                                                </div>
                                                @endif
                                                @if($bankDetails->iban)
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">IBAN</label>
                                                    <p class="text-base">****{{ substr($bankDetails->iban, -4) }}</p>
                                                </div>
                                                @endif
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div class="space-y-3">
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">Address</label>
                                                    <p class="text-base">{{ $bankDetails->bank_address ?? 'N/A' }}</p>
                                                </div>
                                                <div class="grid grid-cols-3 gap-3">
                                                    <div>
                                                        <label class="text-sm font-medium text-muted-foreground">City</label>
                                                        <p class="text-base">{{ $bankDetails->bank_city ?? 'N/A' }}</p>
                                                    </div>
                                                    <div>
                                                        <label class="text-sm font-medium text-muted-foreground">State</label>
                                                        <p class="text-base">{{ $bankDetails->bank_state ?? 'N/A' }}</p>
                                                    </div>
                                                    <div>
                                                        <label class="text-sm font-medium text-muted-foreground">ZIP Code</label>
                                                        <p class="text-base">{{ $bankDetails->bank_zip_code ?? 'N/A' }}</p>
                                                    </div>
                                                </div>
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">Country</label>
                                                    <p class="text-base">{{ $bankDetails->bank_country ?? 'N/A' }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mt-6">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                ...
                                                <div class="grid grid-cols-3 gap-3">
                                                    <div>
                                                        <label class="text-sm font-medium text-muted-foreground">City</label>
                                                        <p class="text-base">{{ $bankDetails->beneficiary_city ?? 'N/A' }}</p>
                                                    </div>
                                                    <div>
                                                        <label class="text-sm font-medium text-muted-foreground">State</label>
                                                        <p class="text-base">{{ $bankDetails->beneficiary_state ?? 'N/A' }}</p>
                                                    </div>
                                                    <div>
                                                        <label class="text-sm font-medium text-muted-foreground">ZIP Code</label>
                                                        <p class="text-base">{{ $bankDetails->beneficiary_zip_code ?? 'N/A' }}</p>
                                                    </div>
                                                </div>
                                                <div>
                                                    <label class="text-sm font-medium text-muted-foreground">Country</label>
                                                    <p class="text-base">{{ $bankDetails->beneficiary_country ?? 'N/A' }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    @endif

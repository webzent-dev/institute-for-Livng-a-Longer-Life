        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                ...
                <select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" id="filterDate">
                    ...
                    <option value="all" {{ !request('date_filter') || request('date_filter') == 'all' ? 'selected' : '' }}>All Time</option>
                </select>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    <input type="text" class="w-full px-3 py-2 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                           id="searchEmail" placeholder="Search by email..." value="{{ request('search_email') }}">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" style="min-width: 200px;">Subject</th>
                    ...
                    @if(isset($emailLogs) && $emailLogs->count() > 0)
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-900">
                                <div class="line-clamp-1" style="display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden; min-width: 200px;">{{ $log->subject }}</div>
                            </td>
...
$(document).ready(function() {
    const filterElements = ['filterDate', 'filterStatus', 'searchEmail'];
...
window.exportLogs = function() {
    ...
    try {
        ...
        // Export is now implemented - open in new window to download CSV

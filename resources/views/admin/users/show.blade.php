        ...
        <main class="flex-1 p-8 bg-white ">
            <div class="space-y-6">
                ...
                <div class="flex gap-2">
                    ...
                    <form id="user_delete_form_{{$userDetail->id}}" action="{{url('admin/users/'.$userDetail->id)}}" method="POST">
                        @csrf
                        @method('DELETE')
                    </form>
                </div>
            ...
            <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
                ...
                <div class="p-6 pt-0">
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="text-md font-medium text-muted-foreground">Plan Name</label>
                            <p class="text-lg text-black">{{$userDetail->plan_name ?? '-'}}</p>
                        </div>
                        <div>
                            <label class="text-md font-medium text-muted-foreground">Plan Price</label>
                            <p class="text-lg text-black">{{$userDetail->plan_price ?? '-'}}</p>
                        </div>
                        <div>
                            <label class="text-md font-medium text-muted-foreground">Plan Period</label>
                            <p class="text-lg text-black">{{$userDetail->plan_period ?? '-'}}</p>
                        </div>
                        <div>
                            <label class="text-md font-medium text-muted-foreground">Plan Expiry</label>
                            <p class="text-lg text-black">{{$userDetail->plan_expiry ?? '-'}}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
                ...
                <div class="p-6 pt-0">
                    @if($paymentHistory->isEmpty())
                        <p class="text-lg text-black">No payment history available.</p>
                    @else

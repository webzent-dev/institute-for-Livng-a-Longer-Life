                    ...
                    <div class="py-4 rounded-lg border bg-card text-card-foreground shadow-sm">
                        ...
                        <form method="POST" id="editZoomSessionForm" name="editZoomSessionForm" action="{{ route('admin.zoom-sessions.update', $zoomSessionDetail->id) }}" enctype="multipart/form-data" class="space-y-3 overflow-y-auto scrollbar-custom scroll-smooth px-5">
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-3">
                                <div class="space-y-2">
                                    <x-form.date-picker label="Date" type="date" name="date" value="{{$zoomSessionDetail->date}}" placeholder="dd-mm-yyyy" automcomplete="off" required  />
                                </div>
                                <div class="space-y-2">
                                    <x-form.time-picker label="Time" type="time" name="time" value="{{$zoomSessionDetail->time}}" placeholder="02:15 PM" automcomplete="off" required />
                                </div>
                            </div>

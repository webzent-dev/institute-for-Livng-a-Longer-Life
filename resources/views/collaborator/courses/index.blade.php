            ...
            <main class="flex-1 p-8  bg-white ">
                <div class="space-y-6">
                    ...
                    <div class="flex justify-between items-center  ">
                        <div class="">
                            <h1 class="text-3xl font-bold text-left mb-0">My Courses</h1>
                            <p class="text-muted-foreground text-lg">Manage your educational content</p>
                        </div>
                        <div class="right-3">
                    ...
                    <!---Courses Start Here---->
                    <div id="collaborator_courses" class="rounded-lg border bg-card text-card-foreground shadow-sm">
                        @if($courses->count() > 0)
                            <div class="flex flex-col space-y-1.5 p-6">
                                <div class="flex justify-between items-center">
                                    <div>
                                        <h3 class="text-2xl font-semibold leading-none tracking-tight">All Courses</h3>
                                    </div>
                                    <div class="w-[220px]">
                                                ...
                                                <tr class="border-b transition-colors hover:bg-muted/50">
                                                    ...
                                                    <td class="p-4 align-middle">
                                                        <div 
                                                            ...
                                                            data-url="{{ route('collaborator.courses.status', $course->id) }}"
                                                        >
                                                    ...
                                                    <td class=" justify-items-center ">
                                                        <div class="flex gap-2">
                                                            <x-button-use href="{{url('collaborator/courses/'.$course->id)}}" label="View" variant="outline" icon="eye" class="pl-0 pr-0 w-24 h-10"/>
                                                            <button class="h-9 rounded-md px-3 hover:bg-accent text-destructive" onclick="deleteFromList('{{$course->id}}','course')">
                                                                <i data-lucide="trash-2" class="w-4 h-4"></i>
                                                            </button>
                                                            <form id="course_delete_form_{{$course->id}}" action="{{ route('collaborator.courses.delete', $course->id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
                                                        </div>
                                    ...
                                    <div class="px-6 py-4 border-t border-gray-100">
                                        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                                            <div class="text-sm text-gray-500">
                                                Showing <span class="font-semibold text-gray-700">{{ $courses->firstItem() }}</span> 
                                                to <span class="font-semibold text-gray-700">{{ $courses->lastItem() }}</span> 
                                                of <span class="font-semibold text-gray-700">{{ $courses->total() }}</span> courses
                                            </div>
                        ...
                        @else
                            <div class="p-6 flex flex-col items-center justify-center py-12">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-video h-12 w-12 text-muted-foreground mb-4">

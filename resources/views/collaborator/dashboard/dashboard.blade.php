...
<div x-data="{ show: true }"
    ...
    x-show="show"
    x-transition
    class="fixed top-5 right-5 z-50 rounded-lg bg-green-600 px-5 py-3 text-white shadow-lg">
    {{ session('success') }}
</div>
@endif
            ...
            <div class="space-y-8">
                ...
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    <div class="rounded-lg border bg-card text-card-foreground shadow-sm p-4 ">
                        ...
                        <div class="">
                            <div class="text-[2.2rem] font-bold leading-none">${{number_format($collaboratorRevenue, 2)}}</div>

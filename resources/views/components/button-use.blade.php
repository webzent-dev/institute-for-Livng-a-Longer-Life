...
@php
    ...
    // Variants
    $variants = [
        'primary' => 'gradient-primary text-primary-foreground hover:opacity-90 shadow-lg font-bold rounded-full transition-all duration-200 hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]',

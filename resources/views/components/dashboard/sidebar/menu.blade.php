...
@if(in_array($role, ['admin','super_admin']))
    ...
    <x-dashboard.sidebar.nav_link icon="handshake" label="Collaborators" route="collaborators.index" />
    ...
    <x-dashboard.sidebar.nav_link icon="crown" label="Memberships Plans"  route="admin.manage-membership" />
    ...
    <x-dashboard.sidebar.nav_link icon="webcam" label="Zoom Sessions" route="admin.zoom-sessions" />
    <x-dashboard.sidebar.nav_link icon="layout-template" label="Content Management" route="admin.content.management" />
    <x-dashboard.sidebar.nav_link icon="map-pin" label="Locations" route="admin.locations" />
    <x-dashboard.sidebar.nav_link icon="quote" label="Testimonials" route="admin.testimonials" />
    <x-dashboard.sidebar.nav_link icon="video" label="Video Testimonials" route="admin.video-testimonials" />
    <x-dashboard.sidebar.nav_link icon="folder-tree" label="FAQ Categories" route="admin.faq-categories" />
    <x-dashboard.sidebar.nav_link icon="messages-square" label="FAQs" route="admin.faqs" />
    <x-dashboard.sidebar.nav_link icon="library" label="Help Categories" route="admin.help-categories" />
    <x-dashboard.sidebar.nav_link icon="book-open" label="Help Articles" route="admin.help-articles" />
    <x-dashboard.sidebar.nav_link icon="circle-play" label="Intro Videos" route="admin.intro-videos" />
    <x-dashboard.sidebar.nav_link icon="mail" label="Email Management" route="admin.email.index" />
    <x-dashboard.sidebar.nav_link icon="bell" label="Subscribers" route="admin.subscribers" />

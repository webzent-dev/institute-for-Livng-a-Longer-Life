...
@section('title', 'New collaborator registration')
@section('preheader', 'A new collaborator has registered and is awaiting approval.')
@section('heading', 'New collaborator registration')
...
@section('content')
    ...
    <p style="margin:0 0 16px 0;">
        A new collaborator has applied to join the network. Their details are below.
    </p>
    ...
    <p style="margin:0 0 8px 0;">
        Please review the application in the admin panel and approve the account when you are ready.
    </p>

    @include('emails.partials.button', ['url' => url('/admin/collaborators'), 'label' => 'Review in Admin Panel'])
@endsection

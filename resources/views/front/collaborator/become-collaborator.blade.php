...
<main class="flex-1">
        ...
        >
            ...
            <p
            class="text-xl text-muted-foreground max-w-3xl mx-auto"
            >
            Join our network of distinguished health professionals and help us
            empower individuals on their journey to optimal health and longevity.
            </p>
        </div>
        </section>
        ...
        <div class="lg:col-span-2">
            <div class="rounded-lg border bg-card text-card-foreground shadow-sm max-w-4xl mx-auto  ">
                ...
                <form id="collabForm" method="POST" action="{{ route('become.collaborator.store') }}" class="p-6 pt-0">
                    ...
                    <!-- Submit -->
                    <x-button-use type="submit" full="true" class="btn-hero py-3 w-full mt-6">
                        Submit Application
                    </x-button-use>
                </form>

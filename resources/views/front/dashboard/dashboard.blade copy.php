    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="flex-1 p-4 md:p-6 overflow-y-auto scrollbar-custom">
                <!-- Welcome Card -->
                <div class="bg-gradient-to-r from-green-500 to-amber-600 rounded-2xl p-6 text-white mb-6 shadow-md">
                    <div class="flex flex-col md:flex-row md:items-center justify-between">
                        <div>
                            <h2 class="text-2xl font-semibold mb-2">Welcome back, Dr. Zeines!</h2>
                            <p class="text-primary-100 mb-4 max-w-2xl">Your team's performance is up by 24% this month. Keep up the great work!</p>
                            <button class="bg-white text-green-600 font-medium px-5 py-2.5 rounded-xl hover:bg-amber-500 transition-all shadow-sm">
                                View Reports
                            </button>
                        </div>
                        <div class="mt-6 md:mt-0">
                            <div class="w-16 h-16 md:w-20 md:h-20 rounded-full bg-white/20 flex items-center justify-center mx-auto">

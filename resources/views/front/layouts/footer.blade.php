            ...
            <div class="col-span-1 md:col-span-2 text-left">
                ...
                <div class="flex space-x-4 justify-start">
                    @if(!empty($webSettingData->facebook_url))
                        <a href="{{$webSettingData->facebook_url}}" target="_blank" class="iconbg">
                    ...
                    @if(!empty($webSettingData->instagram_url))
                        <a href="{{$webSettingData->instagram_url}}" target="_blank" class="iconbg">
                    ...
                    @if(!empty($webSettingData->twitter_url))
                        <a href="{{$webSettingData->twitter_url}}" target="_blank" class="iconbg">
                    ...
                    @if(!empty($webSettingData->youtube_url))
                        <a href="{{$webSettingData->youtube_url}}" target="_blank" class="iconbg">
                ...
                <ul class="space-y-3">
                    <li class="flex items-start gap-2">
                        ...
                        @if(!empty($siteSettingData->contact_email))
                            <a href="mailto:{{$siteSettingData->contact_email}}" class="flex items-start text-background/80 hover:text-primary transition-colors text-sm mt-2 text-wrap">{{$siteSettingData->contact_email}}</a>
                        @else
                    ...
                    @if(count($locations)>0)
                        <li class="flex items-start text-background/80 text-sm gap-2">
                            ...
                            <div class="space-y-1">
                                <div>
                                    <h3 class="font-semibold text-background mb-4 text-sm">Locations</h3>
                                </div>

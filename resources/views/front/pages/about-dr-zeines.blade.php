...
<main class="flex-1">
            ...
            {{-- <section class=" py-20  bg-stone-50 ">
                <div class="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="relative">
                        <div class="aspect-square rounded-2xl     w-4/5 mx-auto justify-self-end">
            ...
            <section class="gradient-subtle py-20">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="relative">
                        ...
                        <img src="/assets/dr-zeines.webp" alt="Dr. Victor Zeines"
                ...
                <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="rounded-lg border bg-card text-card-foreground   shadow-sm">
                        <div class="p-8 lg:p-12 space-y-6 ">
                            <h2 class="text-3xl font-bold text-foreground mb-6 text-left">
                ...
                <div class="max-w-7xl mx-auto px-4">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        ...
                        @foreach($principles as $p)
                            <x-card class="equal-height ">
                                <x-card-content>
                                    <div class="text-5xl font-bold gradient-primary text-transparent bg-clip-text mb-4">
                                        {{ $p[0] }}
                                    </div>

                                    <h3 class="text-xl font-semibold text-foreground mb-2 text-[20px]">
                                        {{ $p[1] }}
                                    </h3>

      ...
      <section class="section-base bg-gray-100 bg-background relative overflow-hidden" style="background-image: url('{{ asset('assets/features_product_dots.png')}}')">
            <div class="container-base  ">
              <div class="flex justify-center -mt-16">
                ...
                {{-- <div class="absolute top-0 right-0 w-96 h-96 bg-primary/5 rounded-full translate-x-1/2 -translate-y-1/2"></div> --}}
            ...
            />
              {{-- @php
                  $newsContents= [
                      ...
                      'desc' => 'Get access to insightful articles, breakthroughs, and expert advice not found anywhere else.',
                      'btn' => [
                  ]
              @endphp --}}
            <div class="container mx-auto px-4 lg:px-8 relative z-10">
                <div class="max-w-4xl mx-auto text-center">
                    ...
                    <div class="w-full flex justify-center">
                        {{-- <x-card class=" bg-primary/20 "> --}}
                      {{-- <x-card-content class="space-y-4 text-white"> --}}
                    ...
                    {{-- Laravel Form {{ route('newsletter.subscribe') }} --}}

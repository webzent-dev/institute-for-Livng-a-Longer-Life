    ...
    <main class="container-base max-w-7xl  mx-auto px-4 py-6">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="lg:w-1/2">
                ...
                <div class="product-image-container bg-white p-4 mb-4 shadow-md">
                    <div class="relative h-96 flex items-center justify-center">
                        <img id="mainImage" src="{{ asset('assets/vitalboost.webp') }}" alt="TechPro X9 Laptop" class="max-h-full max-w-full zoom-image">
            ...
            <div class="lg:w-1/2">
                <!-- Product Title & Brand -->
                <div class="mb-4">
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900 text-left">Vital Boost - Premium Superfood Wellness Formula (18 oz)</h1>
                ...
                <div class="flex flex-col sm:flex-row gap-4 mb-12">
                    <button id="addToCartBtn" class="flex-1 bg-amber-500 hover:bg-amber-600 text-white font-semibold py-3 px-6 rounded-lg flex items-center justify-center transition duration-200">
                        <i class="fas fa-shopping-cart mr-2"></i> Add to Cart
                    </button>
                    <button id="buyNowBtn" class="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 px-6 rounded-lg flex items-center justify-center transition duration-200">

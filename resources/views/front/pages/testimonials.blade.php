    ...
    <main class="flex-1">
        ...
        <section class="gradient-subtle py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                Real people, real results. Read how our members are transforming their
                health and living longer, healthier lives.
                </p>
            </div>
        </section>
        <section class="py-16 bg-background">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="rounded-lg bg-card text-card-foreground shadow-sm shadow-medium border-2">
                    ...
                    @foreach ($stats as $stat)
                        <x-card class="shadow-medium border-2">
                            <x-card-content class="p-6 text-center">
                                <div class="text-4xl font-bold btn-primary h-10 px-4 py-2  text-transparent bg-clip-text mb-2">
                                    {{ $stat['number'] }}
                                </div>

    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
            <div class="flex items-center mb-4">
                ...
                <input type="text" id="order_search" name="order_search" placeholder="Search orders..." onkeyup="searchOrders()" class="ml-auto p-2 border border-gray-300 rounded-md text-sm focus:ring-primary focus:border-primary">
            </div>
                        ...
                        @forelse($orders as $order)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('member.order-details', $order->id) }}" class="inline-flex items-center justify-center gap-2 text-sm font-medium h-9 rounded-md px-3 hover:bg-accent text-blue-600 hover:text-blue-800">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center">
                <div class="text-3xl font-bold text-green-600">{{ $orders->total() }}</div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center">
                <div class="text-3xl font-bold text-blue-600">{{ count($inProgressOrders) }}</div>

    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ url()->previous() }}"
           class="inline-flex items-center gap-2 px-4 py-2
                  rounded-lg border bg-white text-gray-700
...
@endif
    ...
    <input type="hidden" name="user_id" value="{{ auth()->id() }}">
        ...
        <div class="col-span-12 md:col-span-6">
            ...
            <input type="text" name="name" value="{{ old('name', $product->name ?? '') }}" class="w-full border rounded-lg px-3 py-2" placeholder="Enter product name" >
        </div>
    
        <!-- Price -->
        <div class="col-span-12 md:col-span-6">
            <label class="block text-sm font-medium mb-1">Price</label>
            <input type="number" name="price" value="{{ old('price', $product->price ?? '') }}" class="w-full border rounded-lg px-3 py-2"
            placeholder="Enter product price" step="0.01">
        </div>

        <div class="col-span-12 md:col-span-6">
            <label class="block text-sm font-medium mb-1">Discounted Price</label>
            <input type="number" name="discounted_price" value="{{ old('discounted_price', $product->discount ?? '') }}" class="w-full border rounded-lg px-3 py-2"
            placeholder="Enter discounted price" step="0.01">
        </div>

        <div class="col-span-12 md:col-span-6">
            <label class="block text-sm font-medium mb-1">Original Price</label>
            <input type="number" name="original_price" value="{{ old('original_price', $product->originalPrice ?? '') }}" class="w-full border rounded-lg px-3 py-2"
         ...
         <div class="col-span-12 md:col-span-6">
            ...
            <input type="text" name="rating" value="{{ old('rating', $product->rating ?? '') }}" class="w-full border rounded-lg px-3 py-2"
            placeholder="Enter rating">
        </div>

         <div class="col-span-12 md:col-span-6">
            <label class="block text-sm font-medium mb-1">Reviews</label>
            <input type="text" name="reviews" value="{{ old('reviews', $product->reviews ?? '') }}" class="w-full border rounded-lg px-3 py-2"

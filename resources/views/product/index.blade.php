    ...
    <tbody class="bg-white divide-y divide-gray-200">
        @forelse($products as $key => $product)
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3">
                    <span class="px-2 py-1 text-xs rounded {{ $product->status === 'active' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }}">
                ...
                <td class="px-4 py-3 text-right flex justify-end space-x-2">
                    ...
                    <form action="" method="POST" onsubmit="return confirm('Are you sure you want to delete this product?');">
                        ...
                        <button type="submit" class="text-red-600 hover:text-red-800" title="Delete">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M8.257 3.099c.366-.446.958-.446 1.324 0l.917 1.112h5.502a.75.75 0 010 1.5h-1.26l-.345 10.448a2 2 0 01-2 1.952H6.14a2 2 0 01-2-1.952L3.795 5.711H2.535a.75.75 0 010-1.5h5.502l.22-.267zm1.243 2.401L9.5 5.5 9.5 15h1V5.5l-.003-.001z" clip-rule="evenodd"/>
                            </svg>
                        </button>
                    </form>
                </td>

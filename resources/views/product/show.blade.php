                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex gap-2">
                            ...
                            @if(auth()->user()->role === 'collaborator')
                                <form id="product_delete_form_{{$productDetail->id}}" action="{{ route('products.delete',$productDetail->id) }}" method="POST">
                            @else
                    ...
                    <div class="py-4 rounded-lg border bg-card text-card-foreground shadow-sm">
                        ...
                        <form method="POST" id="editProductForm" name="editProductForm" action="{{ route('admin.products.update', $productDetail->id) }}" enctype="multipart/form-data" class="space-y-3 overflow-y-auto scrollbar-custom scroll-smooth px-5">
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-3">
                                ...
                                {{-- Upload Section --}}
                                <!-- <div class="space-y-2">
                                    <label class="text-sm font-medium">Upload Product Images</label>
                                    ...
                                    {{-- Image Count --}}
                                    <div id="image-count" class="text-sm text-primary font-medium hidden"></div>
                                </div> -->

                                <!-- <div class="mt-4">
                                    <x-form.switch name="is_published" label="Active" :checked="true" on-value="active" off-value="inactive" on-label="Published" off-label="Inactive" class="pt-8"/>
                                </div> -->
